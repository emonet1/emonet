...
function processExcelDataForFirestore(excelData) {
    ...
    console.log('处理后的数据结构验证:', {
        ...
        headersList: typeof processedData.headersList,
        headersMapType: typeof processedData.headersMap,
        headersMapIsArray: Array.isArray(processedData.headersMap),
        dataRowsType: typeof processedData.dataRows,
        dataRowsIsArray: Array.isArray(processedData.dataRows),
        totalRows: typeof processedData.totalRows,
        headersMapKeys: Object.keys(processedData.headersMap).length,
        dataRowsKeys: Object.keys(processedData.dataRows).length
    });
...
async function processExcelFileCommon(isAdmin) {
    ...
    try {
        ...
        // 创建最终的文档对象 - 直接使用processedData中已经扁平化的数据
        const excelDoc = {
            fileName: processedData.fileName,
            headersMap: processedData.headersMap,
            headersList: processedData.headersList,
            dataRows: processedData.dataRows,
        ...
        console.log('📝 最终保存的文档结构:', {
            ...
            headersMapIsArray: Array.isArray(excelDoc.headersMap),
